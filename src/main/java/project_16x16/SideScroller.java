...
public class SideScroller extends PApplet {
    ...
    public enum GameScenes {
        ...
        HOST_MENU(mHostMenu), CLIENT_MENU(mClientMenu), GRAPHIC_SETTINGS(graphicSettings), CONFIGURE_CONTROLS(configureControls), AUDIO_SETTINGS(audioSettings), STORY_MODE(story);
